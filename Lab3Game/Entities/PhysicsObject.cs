...
namespace Lab3Game.Entities
{
    public class PhysicsObject
    {
        ...
        public PhysicsObject(GameObjectComponent goComponent, World world)
        {
            var verts = CreateVertices(goComponent.mesh, goComponent.pos, goComponent.scale, goComponent.rotation);
        ...
        private Vertices CreateVertices(Mesh<VertexPositionTexture> mesh, Vector2 pos, Vector2 scale, float rotation)
        {
