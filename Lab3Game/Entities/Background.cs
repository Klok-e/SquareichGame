...
namespace Lab3Game.Entities
{
    public class Background : IRenderable
    {
        ...
        public Background(Vector2 pos, Vector2 scale)
        {
            _go = new GameObjectComponent<CloudyBackgroundEffect>(Models.Instance.quad, pos, scale, 0f, Effects.Instance.cloudsEffect);
        }
